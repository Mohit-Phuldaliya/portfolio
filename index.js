...
p_btns.addEventListener("click", (e) => {
  //passed call back function with help of arrow function
  ...
  p_image_elem.forEach((curElem) =>
    curElem.classList.add("p-image-not-active")
  ); //hidding all images by adding hidden class

  img_active.forEach((curElem) =>
    curElem.classList.remove("p-image-not-active")
  ); //unhide by removing class of those images whose button is clicked
});
